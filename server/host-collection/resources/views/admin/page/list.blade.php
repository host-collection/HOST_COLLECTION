...
@section('content')
    ...
    <div class="breadcrumb-holder">
   	...
   	<section class="forms">
        <div class="container-fluid">
            <header> 
                <h1 class="h3 display">Danh sách trang</h1>
            </header>
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div class="form-group row" id='yume-label'>
                                        <label class="col-sm-4 form-control-label">Tên trang</label>
                                        <div class="col-sm-8">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Trang ( {{$data->total()}} )
                    </div>
                            ...
                            <tbody>
                                @foreach($data as $list)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success" href="/admin/page/edit/{{$list['id']}}"><i class="fas fa-edit"></i> Sửa</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
