function initEditor(el){
	CKEDITOR.replace(el,{
		...
		width: '100%',
		uiColor:'#e5e5e5',
		filebrowserBrowseUrl : 'http://'+window.location.host+ '/frontend/admin/ckeditor/ckfinder/ckfinder.html',
        filebrowserImageBrowseUrl :'http://'+window.location.host+ '/frontend/admin/ckeditor/ckfinder/ckfinder.html?Type=Images',
