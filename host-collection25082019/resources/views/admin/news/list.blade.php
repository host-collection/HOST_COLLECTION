...
@section('content')
    ...
    <div class="breadcrumb-holder">
   	...
   	<section class="forms">
        <div class="container-fluid">
            <header> 
                <h1 class="h3 display">Danh sách tin tức</h1>
            </header>
                            ...
                            <tbody>
                                @foreach($data as $list)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/upload/news/small/{{$list['picture']}}" style="width: 200px; height: 100px">
                                        </td>
                                        <td>
                                            @if($list['status']=='1')
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-success" href="/admin/news/edit/{{$list['id']}}"><i class="fas fa-edit"></i> Sửa</a>

                                            <a class="btn btn-sm btn-danger click_remove" href="/admin/news/remove?id=<?php echo $list['id'];?>&_token={{ csrf_token() }}"><i class="far fa-trash-alt"></i> Xóa </a></td>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
