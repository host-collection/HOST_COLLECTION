    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Thay đổi dự án</li>
            </ul>
        </div>
    </div>
    <div class="row-fluid">
    ...
    {!! Form::open(['method'=>'post','files'=>true, 'class'=>'form-horizontal']) !!}
        <section class="forms">
            <div class="container-fluid">
                <!-- Page Header-->
                <header> 
                    <h1 class="h3 display">Thay đổi dự án</h1>
                </header>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                ...
                                <div class="form-group row" id='yume-label'>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="radio" >
                                            <label>
                                                {!! Form::radio('is_hot','1',
                                                (($data['is_hot'])=='1')? true: false) !!} Hiển thị
                                            </label>
                                        </div>
                                        <div class="radio">
                                            <label>
                            ...
                            <div class="card-body">
                                <div class="form-group row" id="yume-label">
                                    ...
                                    <div class="image-wrapper">
                                        <img src="/upload/project/{{$data['picture']}}">
                                    </div>
                                </div>
